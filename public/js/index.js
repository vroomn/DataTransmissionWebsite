...
(() => {
    ...
    class PrintLines {
        constructor(lines) {
            ...
            this.lineData = [];
            this.print("SSH CONNECT -> CUSTOMER DEVICE");
            this.print("Congrats on making it to the terminal, don't forget the 'help' command!.");
        }
        print(message) {
    ...
    function commands(command) {
        switch (command.toLowerCase()) {
            case "help":
                ...
                break;
            case "whois":
                lines.print("This is the USER computer, they have the software and hardware necesary to prepare packets for transit and transmit them, or recieve and decypher them. The packet must be carefully constructed as to not be misread" +
                    "by any other devices in the chain of passing information.");
                lines.print("The user transmitted it's request at: [ 5 / 10 / 23 ][ 15:47:21 ]");
                break;
            case "traceroute":
            ...
            case "clear":
                ...
                break;
            case "next":
                window.location.href = "http://localhost:3000/Home_Router";
                break;
            case "back":
                lines.print("This is the first stop, there is nothing to go back to.");
                break;
            default:
