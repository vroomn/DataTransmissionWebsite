...
(() => {
    ...
    class PrintLines {
        constructor(lines) {
            ...
            this.lineData = [];
            this.print("SSH CONNECT -> COMPANY ROUTER");
        }
        print(message) {
    ...
    function commands(command) {
        switch (command.toLowerCase()) {
            case "help":
                ...
                break;
            case "whois":
                lines.print("This is the router of the company, in our case it is a two component system of a router and network switch. The router recieves the data from the open internet and the network switch handles distributing it within the datacenter.");
                break;
            case "traceroute":
            ...
            case "clear":
                ...
                break;
            case "next":
                window.location.href = "http://localhost:3000/Company_Server";
                break;
            case "back":
                window.location.href = "http://localhost:3000/Company_Isp";
                break;
            default:
