...
(() => {
    ...
    class PrintLines {
        ...
        constructor(lines: number) {
            ...
            this.lineData = [];
            this.print("SSH CONNECT -> CUSTOMER LOCAL ISP");
        }
    ...
    function commands(command: string) {
        switch (command.toLowerCase()) {
            ...
            case "whois":
                lines.print("This is the ISP for the USER's network and devices, it intakes the packet forwarded by the USER router and analyzes where it needs to go next. It typically server a very small community of people.");
                break;
