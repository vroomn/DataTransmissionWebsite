...
(() => {
    ...
    class PrintLines {
        ...
        constructor(lines: number) {
            ...
            this.lineData = [];
            this.print("SSH CONNECT -> INTERNET BACKBONE");
        }
    ...
    function commands(command: string) {
        switch (command.toLowerCase()) {
            ...
            case "whois":
                lines.print("This is the CORE of the internet, this is where most data will be transmitted the fastest and furthest, in some cases across oceans. In our case it merely takes the East Coast user's packet to our West Coast based server provider.");
                break;
            ...
            case "back":
                window.location.href = "http://localhost:3000/Local_Isp";
                break;
