...
(() => {
    ...
    class PrintLines {
        ...
        constructor(lines: number) {
            ...
            this.lineData = [];
            this.print("SSH CONNECT -> CUSTOMER ROUTER");
        }
    ...
    function commands(command: string) {
        switch (command.toLowerCase()) {
            ...
            case "whois":
                lines.print("This is the ROUTER for the USER's network, it will transalte the Local IP of the USER's computer into a globlal IP and pass on the packet as per configuration.");
                break;
